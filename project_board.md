...
- Phase 3 partial: durable job state machine, retry/dead-letter, resource admission, priority aging, backpressure, cursor/cache and worker loop core.
...
- Phase 3 remaining: full pipeline stage chain, replay action, token-bucket/micro-batch detail and dead-letter UI visibility.
