...
- Phase 5 partial: local multimodal evidence baseline for text, quote, visual alt/OCR, audio-video presence, relationship signal, missingness and offline text benchmark harness.
