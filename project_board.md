...
- Phase 4 partial: exact SHA-256 media hash separated from `dhash64-v1` perceptual hash, Hamming threshold helper, small-batch cluster test, content-addressed local store, manifest refcount, SQLite lifecycle records, lifecycle audit events, retention snapshots, protected-original quota/LRU policy and unreferenced-file GC.
...
- Phase 4 remaining: video/audio lifecycle.
