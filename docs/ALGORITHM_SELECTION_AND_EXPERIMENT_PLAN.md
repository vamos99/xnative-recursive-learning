...
Kod-backed P5-010 baslangici: `xnative/evaluation/text_benchmark.py`, TF-IDF+MultinomialNB, TF-IDF+logistic regression ve HashingVectorizer+SGD modellerini ayni zaman sirali split uzerinde kosar. Rapor; class count, train/test zaman siniri, duplicate text hash overlap uyarisi, accuracy, macro-F1, train/predict sureleri ve secilen train fraction noktalarinda learning-curve ozetlerini dondurur. Bu omurga calibration raporunun altyapisidir; tek basina champion model karari degildir.
