...
- Hardware preflight now has test-covered RSS soft limit, CPU fallback, GPU/VRAM gate and single-heavy-model admission decisions; real target-machine soak is still missing.
