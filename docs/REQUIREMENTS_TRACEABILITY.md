...
| Gercek review UI | P11 | Streamlit operasyon/dead-letter panel temeli var; capture -> suggestion -> review -> feedback urun akisi yok | UI E2E ve screenshot QA |
...
| Hedef donanimda surekli calisma | P5-009, P12 | Hedef donanim tasarimi ve kabul kapisi var; bu branch'te runtime preflight kodu yok, PR #7'de acik | 8 GB/i5/GTX 1050 preflight + soak ve OOM testi |
| Gemini opsiyonel enrichment | P9-004, P9-007 | Politika dogrulandi; adapter yok | Proje tier/kota/cost/fallback integration |
| Algoritma secimi ve model terfisi | P5-010..012, P6-007..010, P8-008..010, P10-008..010, P12-007..008, P13-007 | Karar matrisi ve teknoloji radari var; P5-010 icin local text benchmark, time split, duplicate leakage audit ve learning-curve noktalari var; resource profile/champion registry yok | Time-split benchmark + resource profile + champion/challenger kaydi |
