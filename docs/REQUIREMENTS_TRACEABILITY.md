...
| Hedef donanimda surekli calisma | P5-009, P12 | Kismi: hardware preflight, RSS soft limit, CPU fallback, GPU/VRAM gate ve tek agir model admission policy var; benchmark/soak yok | `tests/unit/test_hardware_preflight.py` + 8 GB/i5/GTX 1050 soak ve OOM testi |
